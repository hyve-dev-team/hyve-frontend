...
const ApartmentDetails = () => {
  ...
  const { capacity, joinQueue, upgradeTier, getQueueForApartment } =
    useQueueStore();
  ...
  const fetchPropertyQueueStatus = async () => {
    ...
    try {
      const [data, summary] = await Promise.all([
        ...
        getPropertyQueueSummaryApi(apartmentID).catch(() => ({
          totalInQueue: 0,
          estimatedWaitHours: 0,
          nextPosition: 1,
        })),
  ...
  // Fee breakdown & renewal toggle state
  const [isRenewalFee, setIsRenewalFee] = useState(false);
  const [showFeeDetails, setShowFeeDetails] = useState(true);
  const rentPackage = calculateRentPackage(apartment, isRenewalFee);
  const inspectionFee = calculateInspectionFee(apartment);
  ...
  const handleToggleSave = async () => {
    ...
    try {
      if (nextState) {
        ...
        hyveSuccess(
          "Saved to Wishlist",
          "Apartment added to your saved listings.",
        );
      } else {
    ...
    apartment?.images && apartment.images.length > 0
      ? apartment.images.filter(
          (img) =>
            img &&
            typeof img === "string" &&
            !img.includes("apartment-image-1.png"),
        )
      : [];
            ...
            <div className="px-3 pt-5 pb-32 sm:pb-20 sm:px-6 lg:px-8 max-w-7xl mx-auto">
              ...
              <div className="mb-6">
                <div className="flex flex-wrap items-center gap-2 mb-2">
                  ...
                  <span
                    className={`inline-flex items-center gap-1.5 text-[11px] font-bold px-2.5 py-0.5 rounded-md capitalize ${
                  ...
                  {apartment.distanceKm != null && (
                    <span className="inline-flex items-center gap-1 bg-[#EEF2FF] text-[#4F46E5] text-[11px] font-bold px-2.5 py-0.5 rounded-full border border-[#C7D2FE]">
                      📍{" "}
                      {apartment.distanceKm < 1
                        ? `${Math.round(apartment.distanceKm * 1000)}m away`
                        : `${apartment.distanceKm.toFixed(1)} km away`}
                    </span>
                  )}
                </div>
                ...
                <div className="flex flex-wrap items-center gap-4 mt-2 text-xs sm:text-sm text-gray-600">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    >
                      ...
                      {apartment.totalReviews === 1 ? "review" : "reviews"})
                    </Link>
                  </div>
                </div>
              </div>
                ...
                <div className="lg:col-span-7 xl:col-span-8 flex flex-col gap-6">
                    ...
                    {currentMainImage ? (
                      ...
                      <div className="relative aspect-[16/10] sm:aspect-[16/9] w-full bg-gray-50 flex flex-col items-center justify-center text-center p-6">
                        ...
                        <p className="text-xs text-gray-400 mt-1">
                          Photos will appear here once uploaded by the landlord
                        </p>
                      </div>
                    )}
                  ...
                  <div className="bg-white rounded-2xl border border-gray-200 p-5 shadow-xs">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                      ...
                      <div className="bg-gray-50 rounded-xl p-3 border border-gray-100">
                        ...
                        <p
                          className="text-xs sm:text-sm font-bold text-gray-900 mt-0.5 truncate"
                          title={apartment.nearbyDistance}
                        >
                      ...
                      <div className="bg-gray-50 rounded-xl p-3 border border-gray-100">
                        ...
                        <p className="text-xs sm:text-sm font-bold text-gray-900 mt-0.5">
                          {apartment.minimumRentalPeriod
                            ? `${apartment.minimumRentalPeriod} Months Min`
                            : "Monthly / Annual"}
                        </p>
                      </div>
                  ...
                  <div className="bg-white rounded-2xl border border-gray-200 p-5 shadow-xs">
                    ...
                    {apartment.description ? (
                      <div>
                        <p
                          className={`text-xs sm:text-sm leading-relaxed text-gray-700 whitespace-pre-wrap ${
                      ...
                      <p className="text-xs sm:text-sm text-gray-500 italic">
                        The landlord has not provided an extended description
                        for this apartment. All core amenities and verified
                  ...
                  <div className="bg-white rounded-2xl border border-gray-200 p-5 shadow-xs">
                    ...
                    {realAmenities.length > 0 ? (
                      ...
                      <p className="text-xs text-gray-500">
                        Standard verified housing features included. Inquire
                  ...
                  <div className="bg-white rounded-2xl border border-gray-200 p-5 shadow-xs flex items-center justify-between gap-4">
                    <div className="flex items-center gap-3 min-w-0">
                      <div className="w-12 h-12 rounded-full overflow-hidden shrink-0 border-2 border-primary/20 bg-primary/10">
                        <img
                          src={
                            apartment.landlord?.profilePictureUrl ||
                            defaultProfile
                          }
                          alt="Landlord"
                          className="w-full h-full object-cover"
                      ...
                      <div className="min-w-0">
                        <div className="flex items-center gap-1.5">
                          <h4 className="text-sm font-bold text-gray-900 truncate font-poppins">
                            {`${apartment.landlord?.firstName || ""} ${apartment.landlord?.lastName || ""}`.trim() ||
                              "Landlord Host"}
                          </h4>
                          {apartment.landlord?.kycStatus === "VERIFIED" && (
                            <ShieldCheck
                              className="w-4 h-4 text-[#10B981] shrink-0"
                              title="Identity & Title Verified"
                            />
                          )}
                        </div>
                        <p className="text-xs text-gray-500">
                  ...
                  <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm flex flex-col gap-5">
                    ...
                    <div className="pb-4 border-b border-gray-100">
                      <div className="flex items-baseline justify-between">
                        ...
                        {rentPackage.houseRent > 0 && (
                          <div className="text-right">
                            <p className="text-xs font-semibold text-gray-700">
                              {formatNaira(
                                Math.round(rentPackage.houseRent / 12),
                              )}
                            </p>
                    ...
                    {/* Full Rent Package & HYVE Service Fee Breakdown Card */}
                    <div className="p-4 rounded-xl bg-gray-50/80 border border-gray-200 text-xs space-y-3">
                      <div className="flex items-center justify-between pb-2 border-b border-gray-200">
                        <span className="font-bold text-gray-900 font-poppins text-xs">
                          Rent Package & HYVE Fee
                        </span>
                        <div className="inline-flex rounded-lg bg-gray-200 p-0.5 text-[10px] font-semibold">
                          <button
                            type="button"
                            onClick={() => setIsRenewalFee(false)}
                      ...
                      {/* Supplier Package Subtotal */}
                      <div className="pt-2 border-t border-gray-200 flex justify-between items-center font-bold text-gray-800 text-xs">
                        <span>Supplier's Full Package</span>
                        <span>
                          {formatNaira(rentPackage.supplierPackageTotal)}
                        </span>
                      </div>

                      {/* HYVE Platform Fee */}
                      <div className="flex justify-between items-center text-xs text-primary font-semibold bg-orange-50/90 p-2 rounded-lg border border-orange-100">
                        <span>
                          HYVE Service Fee (
                          {isRenewalFee ? "2% renewal" : "5% 1st year"})
                        </span>
                      ...
                      <div className="pt-2 border-t border-gray-200 flex justify-between items-center text-sm font-bold text-gray-900">
                        ...
                        <span className="text-primary text-base font-poppins">
                          {formatNaira(rentPackage.totalPayable)}
                        </span>
                      </div>

                      <p className="text-[10px] text-gray-400 leading-tight">
                        * Supplier package goes 100% to landlord & agent. HYVE
                        Service Fee covers escrow safety, dispute protection &
                        digital lease records.
                      </p>
                    </div>

                    {/* Inspection Tour Fee Note */}
                    <div className="px-3.5 py-2.5 rounded-xl bg-blue-50/70 border border-blue-200/70 text-xs flex items-center justify-between">
                      <div>
                        <p className="font-bold text-blue-950">
                          Inspection Fee: {formatNaira(inspectionFee.totalFee)}
                        </p>
                        <p className="text-[10px] text-blue-700">
                          {inspectionFee.label} (
                          {formatNaira(inspectionFee.supplierBaseFee)} agent
                          logistics + {formatNaira(inspectionFee.hyveShare)}{" "}
                          HYVE)
                        </p>
                      </div>
                    ...
                    <div className="flex flex-col gap-3">
                          ...
                          {existingQueue ? (
                            existingQueue.status === "ACTIVE" ? (
                              <p className="text-green-700 font-semibold flex items-center gap-1">
                                ...
                                <span>
                                  It's your turn! You're Position #1 to inspect
                                  and pay.
                                </span>
                              </p>
                            ) : (
                            ...
                            <div>
                              {queueSummary.totalInQueue === 0 ? (
                                <p className="text-green-700 font-semibold">
                                  🎉 0 people in queue — You'll be first to
                                  inspect and pay!
                                </p>
                                ...
                                <p className="text-gray-700">
                                  ...
                                  — 24 hours until you can inspect.
                                </p>
                              ) : (
                                <p className="text-gray-700">
                                  ⏱️{" "}
                                  <strong className="text-gray-900">
                                    {queueSummary.totalInQueue} people ahead
                                  </strong>{" "}
                                  — {queueSummary.totalInQueue * 24} hours until
                                  you can inspect.
                                </p>
                              )}
                              <p className="text-[11px] text-gray-500 mt-1">
                                Joining is free. Inspection fee is paid only
                                when your 24h turn arrives.
                              </p>
                            </div>
                          )}
                        </div>
                      ...
                      {apartment.rawStatus !== "ACTIVE" ? (
                        ...
                        <button
                          type="button"
                          onClick={() =>
                            navigate(`/user/apartment/${apartment.id}/queue`)
                          }
                        ...
                        >
                          <Users className="w-4 h-4" />
                          <span>
                            In Queue (Position #{existingQueue.position}) — View
                          </span>
                        </button>
                      ) : (
                        <button
                    ...
                    <div className="bg-[#FFF9F5] border border-[#FF630015] rounded-xl p-3.5 text-xs text-gray-700 space-y-2">
                      <div className="flex items-start gap-2">
                        ...
                        <p>
                          <strong className="text-gray-900">
                            Zero Agent Bidding Wars:
                          </strong>{" "}
                          Strict first-come, first-served queue policy.
                        </p>
                      </div>
                      <div className="flex items-start gap-2">
                        <CheckCircle2 className="w-4 h-4 text-primary shrink-0 mt-0.5" />
                        <p>
                          <strong className="text-gray-900">
                            24-Hour Decision Lock:
                          </strong>{" "}
                          Full private inspection window before anyone else.
                        </p>
                      </div>
                      <div className="flex items-start gap-2">
                        <CheckCircle2 className="w-4 h-4 text-primary shrink-0 mt-0.5" />
                        <p>
                          ...
                          Funds held safe until keys and tenancy are verified.
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <p className="text-lg font-extrabold text-primary leading-tight font-poppins">
              ...
              {Number(
                apartment.priceAnnually ||
                  (apartment.price ? apartment.price * 12 : 0),
              ).toLocaleString()}
            </p>
          ...
          {apartment.rawStatus !== "ACTIVE" ? (
            ...
            >
              ...
              <span>
                Join Queue{" "}
                {queueSummary.totalInQueue > 0
                  ? `(${queueSummary.totalInQueue} ahead)`
                  : "(First)"}
              </span>
            </button>
          )}
