const NotificationItem = ({ title, date, read = false, onClick }) => {
    return (
        <button
            type="button"
            onClick={onClick}
            className="flex items-start w-full py-4 text-left transition-colors rounded-md hover:bg-[#FFF6F0] focus:outline-none focus-visible:ring-2 focus-visible:ring-primary px-2 -mx-2 cursor-pointer"
        >
